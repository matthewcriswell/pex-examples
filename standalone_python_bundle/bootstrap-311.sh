...
# Global defaults
VERBOSE=false
PYTHON_TARBALL_URL="https://github.com/astral-sh/python-build-standalone/releases/download/20250529/cpython-3.11.12+20250529-aarch64-unknown-linux-gnu-install_only_stripped.tar.gz"
PYTHON_SHA_URL="https://github.com/astral-sh/python-build-standalone/releases/download/20250529/cpython-3.11.12+20250529-aarch64-unknown-linux-gnu-install_only_stripped.tar.gz.sha256"
TARBALL_NAME="cpython-3.11.12+20250529-aarch64-unknown-linux-gnu-install_only_stripped.tar.gz"
TARBALL_PATH="$HOME/tools/$TARBALL_NAME"
INSTALL_DIR="$HOME/tools/python3.11.12"
